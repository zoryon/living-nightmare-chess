...
CREATE TABLE `match_move` (
    ...
    `specialAbilityUsed` tinyint(1) DEFAULT '0',
    `createdAt` datetime DEFAULT CURRENT_TIMESTAMP,
    PRIMARY KEY (`id`),
    KEY `matchId` (`matchId`),
    KEY `playerId` (`playerId`),
    CONSTRAINT `match_move_ibfk_1` FOREIGN KEY (`matchId`) REFERENCES `match` (`id`) ON DELETE CASCADE,
    CONSTRAINT `match_move_ibfk_2` FOREIGN KEY (`playerId`) REFERENCES `match_player` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `match_piece` (
    ...
    `usedAbility` tinyint(1) DEFAULT '0',
    `captured` tinyint(1) DEFAULT '0',
    PRIMARY KEY (`id`),
    KEY `matchId` (`matchId`),
    KEY `playerId` (`playerId`),
    CONSTRAINT `match_piece_ibfk_1` FOREIGN KEY (`matchId`) REFERENCES `match` (`id`) ON DELETE CASCADE,
    CONSTRAINT `match_piece_ibfk_2` FOREIGN KEY (`playerId`) REFERENCES `match_player` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `match_player` (
    ...
    KEY `matchId` (`matchId`),
    KEY `userId` (`userId`),
    CONSTRAINT `match_player_ibfk_1` FOREIGN KEY (`userId`) REFERENCES `user` (`id`) ON DELETE CASCADE,
