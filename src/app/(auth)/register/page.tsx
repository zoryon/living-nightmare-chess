                ...
                <div className="p-6 sm:p-8">
                    <div className="mb-4 flex items-center justify-center">
                        <div className="inline-flex h-12 w-12 items-center justify-center rounded-xl border border-white/10 bg-white/10 shadow-md">
                            <span aria-hidden className="text-xl">♟︎</span>
                        </div>
                    </div>
                    <div className="mb-6 text-center">
                        <h1 className="text-2xl font-bold tracking-tight">Create your account</h1>
                        <p className="mt-1 text-sm text-slate-300">Join and start playing.</p>
                    </div>
                    <Form {...form}>
                                            ...
                                            <div className="relative">
                                                <span className="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3 text-slate-400">
                                                    ...
                                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="h-5 w-5">
                                                        <path fillRule="evenodd" d="M12 2.25a5.25 5.25 0 1 1 0 10.5 5.25 5.25 0 0 1 0-10.5ZM4.5 20.25a7.5 7.5 0 0 1 15 0 .75.75 0 0 1-.75.75h-13.5a.75.75 0 0 1-.75-.75Z" clipRule="evenodd" />
                                                    </svg>
                                                </span>
                                                <Input className="pl-10 placeholder:text-slate-500" placeholder="CoolPlayer42" {...field} />
                                            </div>
                                        </FormControl>
                                        <FormMessage />
                                    </FormItem>
                                    ...
                                    <FormItem>
                                        ...
                                        <FormControl>
                                            <div className="relative">
                                                ...
                                                >
                                                    {showPassword ? (
                                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="h-5 w-5 cursor-pointer"><path d="M3.53 2.47a.75.75 0 1 0-1.06 1.06l2.124 2.124A12.704 12.704 0 0 0 1.5 12s3 7.5 10.5 7.5a10.21 10.21 0 0 0 4.567-1.06l3.903 3.903a.75.75 0 1 0 1.06-1.06L3.53 2.47ZM12 18c-5.35 0-8.09-5.032-8.887-6 .523-.629 1.65-1.812 3.178-2.79l2.16 2.16A3.75 3.75 0 0 0 12 15.75c.442 0 .866-.077 1.26-.218l1.63 1.63A8.777 8.777 0 0 1 12 18Zm8.887-6c-.278.333-.716.83-1.292 1.39l-1.07-1.07c.843-.708 1.466-1.41 1.66-1.64C19.66 10.279 16.93 6 12 6c-.552 0-1.084.044-1.596.127l-1.68-1.68A10.156 10.156 0 0 1 12 4.5C19.5 4.5 22.5 12 22.5 12a14.875 14.875 0 0 1-1.613 2Z" /></svg>
                                                    ) : (
                                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="h-5 w-5 cursor-pointer"><path d="M12 4.5C4.5 4.5 1.5 12 1.5 12s3 7.5 10.5 7.5S22.5 12 22.5 12 19.5 4.5 12 4.5Zm0 12a3.75 3.75 0 1 1 0-7.5 3.75 3.75 0 0 1 0 7.5Z" /></svg>
                                                    )}
                                                </button>
                                            </div>
                                        </FormControl>
                                    ...
                                    <FormItem>
                                        ...
                                        <FormControl>
                                            <div className="relative">
                                                ...
                                                <Input type={showPassword2 ? "text" : "password"} className="pl-10 pr-10 placeholder:text-slate-500" placeholder="********" {...field} />
                                                <button
                                                    type="button"
                    ...
                    <div className="mt-6 text-center text-sm text-slate-300">
                        ...
                        <Link href="/login" className="font-medium text-indigo-300 underline-offset-4 hover:underline">
                            Sign in
                        </Link>
                    </div>
                </div>
